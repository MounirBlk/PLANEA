...
class PlayerStartedEvent extends MatchEvent with HasMatchState {
  ...
  double get planeaX => state.players[sender!.userId]!.lastKnownX;

  double get planeaY => state.players[sender!.userId]!.lastKnownY;

  double get planeaVelocityY =>
      state.players[sender!.userId]!.lastKnownVelocityY;
