...
import 'package:planea/domain/entities/user_json_parser.dart';
...
class MatchOverviewEntity with EquatableMixin {
  ...
  factory MatchOverviewEntity.fromJson(Map<String, dynamic> json) =>
      MatchOverviewEntity(
        id: json['id'],
        initializedAt: DateTime.fromMillisecondsSinceEpoch(
          json['initializedAt'],
        ),
  ...
  @override
  List<Object?> get props => [id, initializedAt, startedAt, finishedAt, scores];
}
...
class MatchScoreEntity with EquatableMixin {
  ...
  MatchScoreEntity({required this.score, required this.user});
  ...
  @override
  List<Object?> get props => [score, user];
}
