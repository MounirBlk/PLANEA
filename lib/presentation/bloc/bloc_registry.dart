...
import 'package:planea/presentation/pages/splash/cubit/splash_cubit.dart';
...
class AppBlocRegistry extends StatelessWidget {
  ...
  const AppBlocRegistry({super.key, required this.child});
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
          create: (context) => AccountCubit(getIt.get<GameRepository>()),
        ),
        BlocProvider(
          create: (context) => LeaderboardCubit(getIt.get<GameRepository>()),
          lazy: false,
        ),
        BlocProvider(
          create: (context) => PingCubit(getIt.get<MultiplayerRepository>()),
          lazy: false,
        ),
        BlocProvider(
