...
import 'package:planea/presentation/widget/qr_code_widget.dart';
...
class ShareQRContentDialog extends StatefulWidget {
  static Future<String?> show(
    ...
    return showDialog<String?>(
      context: context,
      builder: (context) {
        return ShareQRContentDialog(title: title, data: data);
      },
    );
  }
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        ...
                        context.showToastInfo('Copier dans le presse-papier');
                      },
                    ),
                  ],
                ),
