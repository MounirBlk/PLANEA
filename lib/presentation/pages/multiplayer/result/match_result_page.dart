...
import 'package:planea/domain/entities/match_result_entity.dart';
...
import 'package:planea/presentation/pages/multiplayer/result/cubit/match_result_state.dart';
import 'package:planea/presentation/responsive/screen_size.dart';
import 'package:planea/presentation/widget/app_outlined_button.dart';
...
import 'package:planea/presentation/widget/error_retry_box.dart';
import 'package:planea/presentation/widget/game_back_button.dart';
import 'package:planea/presentation/widget/loading_overlay.dart';
...
class _MatchResultPageContentState extends State<_MatchResultPageContent> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<MatchResultCubit, MatchResultState>(
      ...
      builder: (context, state) {
        ...
        ({int rank, String name, PlaneaType planeaType, int score})?
        currentUserData;
        ...
        if (state.matchResult != null) {
          ...
          if (myScore != null) {
            currentUserData = (
              ...
              planeaType: PlaneaType.fromUserId(myScore.user.id),
              score: myScore.score,
            );
          }
        }
                                  ...
                                  final rawScores = state.matchResult!.scores
                                      ...
                                      .map((entry) {
                                        ...
                                        return (
                                          ...
                                          planeaType: PlaneaType.fromUserId(
                                            record.user.id,
                                          ),
                                          score: record.score,
                                          rank: rank,
  ...
  void _shareScore() {
    ...
    const subject = '🏆 Planea Round Finished! 🏆';
    final message =
        '''
🎉 I finished $rankText place, passing $myScore pipes!

How far can you go? Try Planea now! 🚀
