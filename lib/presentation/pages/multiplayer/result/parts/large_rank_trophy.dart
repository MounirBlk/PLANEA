...
class _LargeRankTrophy extends StatelessWidget {
  ...
  final int rank;
  final ({String name, PlaneaType planeaType, int score})? data;
  ...
  Widget build(BuildContext context) {
    ...
    final trophyWidth = rank == 1
        ? firstTrophyWidth
        : firstTrophyWidth * otherTrophiesRatio;
                ...
                Text(
                  ...
                  style: TextStyle(
                    color: AppColors.getPlaneaColor(
                      data?.planeaType ?? PlaneaType.flutterPlanea,
                    ),
