...
import 'package:planea/presentation/dialogs/share_lobby_dialog.dart';
...
import 'package:planea/presentation/pages/multiplayer/game/parts/last_match_winner_widget.dart';
import 'package:planea/presentation/pages/multiplayer/lobby/parts/auto_jump_widget.dart';
...
class PendingMatchBox extends StatelessWidget {
          ...
          child: Stack(
            children: [
              Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Expanded(child: AutoJumpWidget(state: state)),
                        BigButton(
              ...
              Transform.translate(
                ...
                child: LastMatchWinnerWidget(height: lastWinnerHeight),
              ),
            ],
          ),
        );
  ...
  void _shareLobby(BuildContext context, String matchId) {
    ...
    ShareQRContentDialog.show(context, title: 'Share Lobby', data: url);
  }
}
